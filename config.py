...
DISCORD_TOKEN = "your discord token" # Discord token

MONEY_THRESHOLD = 1.3 # in millions, if the brainrot is less than this number, it will be skipped



# don't touch it if you don't understand what it is.
...
CHILLI_HUB_CHANNELS_ID = {
    ...
    "500k_1m": ["1394958062166474823"], # 500k - 1M channels
